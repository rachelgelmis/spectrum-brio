import alexHR from "assets/img/team/alex.jpg";
...
export const countries = [
  ...
  export const friends = [
      { name: 'Alex Chen', value: 'annie.cruz', photo: alex  },
      { name: 'Freya Fu', value: 'eli.shelton', photo: freya  },
      { name: 'Rachel Gelmis', value: 'loretta.rogers', photo: rachel },
      { name: "John 'The King' Markley", value: 'lloyd.fisher', photo: john },
      { name: 'Macy Webb-Alexander', value: 'tiffany.gonzales', photo: macy },
      { name: 'Emma Millard', value: 'charles.hardy', photo: emma },
      { name: 'Patrick Schwerdtfeger', value: 'rudolf.wilson', photo: patrick },
      { name: 'Anny Gonzalez', value: 'emerald.hensley', photo: anny },
  ];
